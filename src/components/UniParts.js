  ...
  return (
    <section className="py-12 lg:py-[100px] bg-black py-8 relative">
        ...
        <div className="m-auto w-full md:w-[450px] h-auto md:flex-[50%]">
            <img src="https://www.uni.cards/images/nx-wave/app_screen_1.webp" alt="" loading="lazy" className="m-auto w-[80%] h-auto css-1e2fy0l" />
        </div>
    </div>
    <div className="w-full max-w-7xl mx-auto px-6 md:px-4  md:flex relative py-6">
        <div className="mx-auto w-full flex-[50%] flex-grow-0 my-auto">
            <p className="text-[22px] font-medium text-white mb-4 md:text-[40px] leading-[1.2]">
                With Uni, 
                <span className="uni-gradient-primary"><br />you’re always in control.</span> 
            </p>
        ...
        <div className="m-auto w-full md:w-[450px] h-auto md:flex-[50%]">
            <img src="https://www.uni.cards/images/nx-wave/app_screen_2.webp" alt="App-scree" loading="lazy" className="m-auto w-[80%] h-auto css-1e2fy0l" />
        </div>
    </div>
</section>
  )
